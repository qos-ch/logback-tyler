...
class TylerConfigurator extends TylerConfiguratorBase implements Configurator {
    ...
    public Configurator.ExecutionStatus configure(LoggerContext loggerContext) {
        ...
        includeModel.setFile(subst("${JO_PREFIX}/included.xml"));
...
// 14:43:33,411 |-INFO in ch.qos.logback.core.model.processor.DefaultProcessor@72ade7e3 - End of configuration.